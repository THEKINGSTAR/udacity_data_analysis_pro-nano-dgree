...
books = pd.Series(data=['Great Expectations', 'Of Mice and Men',
                        'Romeo and Juliet', 'The Time Machine', 'Alice in Wonderland'])
authors = pd.Series(data=['Charles Dickens', 'John Steinbeck',
                          'William Shakespeare', ' H. G. Wells', 'Lewis Carroll'])
...
# TO DO: Create a dictionary with the data given above
dat = pd.DataFrame({"Book Title": books, "Author": authors, "User 1": user_1,
